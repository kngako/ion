        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    <div className="settings-item">
                        <span className="settings-item-left">AudioCode</span>
                        <div className="settings-item-right">
                            <Select style={{ width: 350 }} value={this.state.codec} onChange={this.handleAudioCodeChange}>
